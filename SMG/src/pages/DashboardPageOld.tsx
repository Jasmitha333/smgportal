                ...
                <div className="flex-1 grid grid-cols-2 gap-x-6 gap-y-2">
                  ...
                  <div className="space-y-1.5">
                    <div>
                      ...
                      <p className="text-sm font-bold text-white">{data.user.employeeId || 'SMG-EMP-001'}</p>
                    </div>
                    <div>
                      <p className="text-[10px] text-blue-200 font-bold uppercase tracking-wide mb-0.5">Department</p>
                      <p className="text-sm font-bold text-white">{data.user.department || 'Engineering'}</p>
                    </div>
                    <div>
                      <p className="text-[10px] text-blue-200 font-bold uppercase tracking-wide mb-0.5">Designation</p>
                      <p className="text-sm font-bold text-white">{data.user.designation || 'Senior Engineer'}</p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-1.5">
                    <div>
                      ...
                      <p className="text-xs font-medium text-white truncate">{data.user.email || 'rohit.sharma@smg.com'}</p>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <p className="text-sm font-bold text-white">{data.user.joiningDate || '15 Jan 2020'}</p>
                    </div>
                  </div>
                </div>
              </div>
