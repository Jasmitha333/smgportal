...
export const AdminDashboard = ({ onNavigate }) => {
  ...
  const departmentStats = [
    ...
    { name: 'Sales & Marketing', employees: 180, attendance: 96, budget: '₹18,00,000', color: 'bg-orange-500' },
    { name: 'Administration', employees: 92, attendance: 99, budget: '₹10,20,000', color: 'bg-pink-500' },
    { name: 'R&D', employees: 200, attendance: 94, budget: '₹14,05,000', color: 'bg-indigo-500' }
  ];
    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-gradient-to-br from-[#0B4DA2] to-[#042A5B] p-6 rounded-[24px] shadow-lg text-white relative overflow-hidden">
